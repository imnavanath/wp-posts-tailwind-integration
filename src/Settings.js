...
import List from '@Tailwind_Integration/List'

const user = {
  name: 'Navanath Bhosale',
  email: 'navanathb@bsf.io',
  imageUrl:
    'https://avatars.githubusercontent.com/u/36153619?v=4',
}
const navigation = [
  { name: 'All Posts', href: '#', current: true },
                            ...
                            <a
                              ...
                              className={classNames(
                                item.current
                                  ...
                                  : 'text-white hover:text-white hover:bg-indigo-500 hover:bg-opacity-75',
